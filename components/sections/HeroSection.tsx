      ...
      <div className="relative z-20 max-w-4xl mx-auto px-6 text-center pt-28 pb-12">
        ...
        >
          ...
          <div className="relative flex h-full w-full items-center justify-center rounded-[22px] bg-gradient-to-br from-pink-400 via-rose-500 to-fuchsia-600 shadow-[0_12px_40px_rgba(236,72,153,0.55)] ring-1 ring-white/30">
            ...
            <span className="relative text-[34px] font-extrabold leading-none text-white drop-shadow-md">✻</span>
          </div>
        </motion.div>
        ...
        >
          Screenshots that{" "}
          <span className="italic font-serif font-normal text-white/90">speak</span> louder
          <br />
          than words
        </motion.h1>
        ...
        >
          Capture, annotate, and share pixel-perfect screenshots in one click. Built for teams who move fast.
        </motion.p>
